...
int generic_setLong( eGeneric* gen , long num );
int generic_setLongLong( eGeneric* gen , long long num);
int generic_setFloat( eGeneric* gen , float num);
int generic_setDouble( eGeneric* gen , double num);
int generic_setChar( eGeneric* gen , char character );
int generic_setString( eGeneric* gen , char* string );
