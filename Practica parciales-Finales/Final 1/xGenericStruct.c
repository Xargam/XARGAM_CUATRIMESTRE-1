...
int generic_setLong( eGeneric* xGen, long num)
{
    int verify = 0;
    if( xGen != NULL )
    {
...
int generic_setLongLong( eGeneric* xGen, long long num )
{
    int verify = 0;
    if( xGen != NULL )
    {
...
int generic_setFloat( eGeneric* xGen, float num )
{
    int verify = 0;
    if( xGen != NULL )
    {
...
int generic_setDouble( eGeneric* xGen, double num )
{
    int verify = 0;
    if( xGen != NULL  )
    {
...
int generic_setChar( eGeneric* xGen, char  character )
{
    int verify = 0;
    if( xGen != NULL )
    {
...
int generic_setString( eGeneric* xGen, char* string )
{
    int verify = 0;
    if( xGen != NULL && string != NULL )
    {
