...
int get_validateIsNum(char* number);               //XG1-1
int get_validateIsRealNum(char* number);           //XG1-2
int get_validateIsAlphabeticStr(char* word);          //XG1-2.1
int get_validateIsAlphanumericStr(char* word);        //XG1-2.2
int get_validateIsGraphicStr(char* word);           //XG1-2.3
void get_zeroFixer(char* number);                       //XG1-3
int get_strNumCmp(char* number1, char* number2);        //XG1-4
