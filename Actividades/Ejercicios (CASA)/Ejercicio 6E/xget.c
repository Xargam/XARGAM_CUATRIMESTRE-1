 ...
 * \param condition menor a 0: el numero ingresado solo sera valido si es menor al numero de referencia.
 * \param condition mayor a 0: el numero ingresado solo sera valido si es mayor al numero de referencia.
 * \param message: mensaje mostrado al solicitar el numero al usuario.
 * \param errorMessage: mensaje mostrado en caso de error.
