...
/** \brief Revisa si en el principio de una cadena se encuentra alguna de las cadenas pasadas por parametro y devuelve el numero de argumento de la misma.
 *
 * \param stringToLook: Cadena la cual se revisara para ver si su comienzo con otra que se haya pasado por parametro.
 * \param totalarguments: Cantidad de cadenas que se ingresar como argumento a la funcion.
 * \param ... : Cada cadena se compara con stringToLook para ver si se esta en el comienzo.
...
Con el ejemplo estas diciendo que hay 3 datos a parsear y el primer se guardara EN UN PUNTERO
...
TENER EN CUENTA QUE LA FUNCION SOLO UTILIZA UN PUNTERO, POR LO TAN TO LAS CONVERSIONES Y LOS
 ...
 * \return Devuelve [0] en caso de llegar al final de un archivo o haberse producido un error.
 *
 */
